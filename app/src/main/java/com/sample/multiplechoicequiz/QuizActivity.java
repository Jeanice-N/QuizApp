...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String SCORE_INDEX = "ScoreIndex";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get question and score saved in onSavedInstanceState method
        ...
        mQuestionLibrary.initAllQuestions(getApplicationContext());
        updateQuestion();
    ...
    //saves current index - retrieved in onCreate - used in screen rotation
    @Override
    public void onSaveInstanceState(Bundle savedInstantState){
        ...
        savedInstantState.putInt(KEY_INDEX, mQuestionNumber);
        savedInstantState.putInt(SCORE_INDEX, mScore);
    }
 }